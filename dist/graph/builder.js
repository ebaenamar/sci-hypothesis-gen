...
export class GraphBuilder {
     ...
     */
    async loadPapersFromCSV(filePath) {
     ...
     */
    classifyConceptType(phrase, patterns) {
            ...
            for (const [target, count] of targets) {
                ...
                if (weight > 0.1) {
                    ...
                    const evidence = Array.from(this.papers.values())
                        .filter(p => sourceConcept.papers.includes(p.id) &&
